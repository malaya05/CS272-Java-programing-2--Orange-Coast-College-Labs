...
public class GameDemo {
	...
	public static void main(String[] args) {
		...
		rowSize = validateInputMin(consoleScanner, "How many rows are in the room?\n", 1, "Please enter a row size > 0.");
		colSize = validateInputMin(consoleScanner, "How many columns are in the room?\n", 1, "Please enter a column size > 0.");
		maxRodents = (rowSize * colSize) - 1;
		numRodents = validateInput(consoleScanner, "How many rodents have invaded the MBCC?\n", 1, maxRodents, 
